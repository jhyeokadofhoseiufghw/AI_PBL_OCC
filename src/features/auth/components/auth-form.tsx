...
const inputClassName =
  "mt-1 w-full rounded-lg border border-zinc-300 px-3 py-2 outline-none focus:border-emerald-600";
...
export function AuthForm({ action, mode }: Props) {
  ...
  return (
    ...
    >
      ...
      <button
        className="w-full rounded-lg bg-emerald-700 px-4 py-2.5 text-sm font-medium text-white disabled:opacity-60"
        disabled={pending}
        type="submit"
      >
