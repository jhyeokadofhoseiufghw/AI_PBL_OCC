...
CREATE TABLE IF NOT EXISTS reservations (
    ...
    lookup_password_must_change BOOLEAN NOT NULL DEFAULT FALSE,
    lookup_password_reset_at TIMESTAMPTZ,
    lookup_password_reset_by UUID REFERENCES organizers(id) ON DELETE SET NULL,
