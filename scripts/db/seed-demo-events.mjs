...
for(const demo of demos){
 ...
 for(let index=0;index<demo.posts.length;index++)await sql`INSERT INTO feed_posts(event_id,image_url,content,created_at) VALUES(${eventId},${`https://picsum.photos/seed/${demo.slug}-feed-${index+1}/1000/1000`},${demo.posts[index]},NOW()-${index}*INTERVAL '1 hour')`;
